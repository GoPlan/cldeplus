...
namespace Cloude {
    namespace Segmentation {
        namespace Transformation {
            ...
            Foundation::Data::SPtrValue Converter::UInt64Converter::Convert(
                ...
                if (value->getDataType() != Foundation::Data::ValueType::UInt64) {
                    ...
                    std::string msg{type + " is not supported by UInt64Converter"};
                    throw Segmentation::Exception::TransformationException{msg};
                }

                uint64_t *tmp = reinterpret_cast<uint64_t *>(value->RawPointerToValueBuffer());
