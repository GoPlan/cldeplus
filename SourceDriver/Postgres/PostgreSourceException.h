...
#ifndef CLOUD_E_CPLUS_SOURCEDRIVER_POSTGRES_POSTGRESOURCEEXCEPTION_H
#define CLOUD_E_CPLUS_SOURCEDRIVER_POSTGRES_POSTGRESOURCEEXCEPTION_H
...
#endif //CLOUD_E_CPLUS_SOURCEDRIVER_POSTGRES_POSTGRESOURCEEXCEPTION_H
