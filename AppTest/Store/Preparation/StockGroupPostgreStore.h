...
#ifndef CLOUD_E_CPLUS_APPTEST_STORE_STOCKGROUPPOSTGRESTORE_H
#define CLOUD_E_CPLUS_APPTEST_STORE_STOCKGROUPPOSTGRESTORE_H
...
#endif //CLOUD_E_CPLUS_APPTEST_STORE_STOCKGROUPPOSTGRESTORE_H
