...
namespace Cloude {
    namespace Foundation {
        ...
        bool Type::Comparer::cldeValueGreater::operator()(const Type::SPtrValue &lhs,
        ...
        bool Type::Comparer::cldeValueGreater::CompareNumeric(
        ...
        bool Type::Comparer::cldeValueGreater::CompareMathematic(
                const Type::SPtrValue &lhs, const Type::SPtrValue &rhs) const {
            return false;
        }
    }
