...
#ifndef CLOUD_E_PLUS_FOUNDATION_TYPE_COMPARER_CLDEVALUELESS_H
#define CLOUD_E_PLUS_FOUNDATION_TYPE_COMPARER_CLDEVALUELESS_H
...
#endif //CLOUD_E_PLUS_FOUNDATION_TYPE_COMPARER_CLDEVALUELESS_H
